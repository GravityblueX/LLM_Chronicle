...
│   ├── 05.md              LaMDA: Google's Dialogue AI Starting Point
...
├── 2022/
│   ├── 01.md              InstructGPT: The Starting Point of RLHF
│   ├── 03.md              Chinchilla: Compute-Optimal Scaling Laws
│   ├── 04.md              DALL·E 2; PaLM 540B; Stability AI Funding
│   ├── 07.md              July 2022: BLOOM, DeepSeek, and the Rise of Open-Source
│   ├── 08.md              Stable Diffusion: The Cambrian Explosion of Open-Source Image Gen
│   ├── 09.md              Whisper: Making Speech Recognition Open Infrastructure
│   ├── 10.md              Elon Musk Acquires Twitter; Meta Galactica
...
│   ├── 08.md              Code Llama: Meta Officially Enters the AI Coding Assistant Race
│   ├── 09.md              Mistral 7B: The 7B That Punched Above Its Weight
│   ├── 11.md              DeepSeek Initial; Yi; 01.AI
│   └── 12.md              Gemini 1.0: Google's First Real Counterattack
├── 2024/
│   ├── 01.md              Opening: GLM-4, Kimi, Mistral API
│   ├── 02.md              Sora: When Video Became Tokens; Gemini 1.5 Pro
│   ├── 03.md              Claude 3: Anthropic's First Time at the Top
│   ├── 04.md              Llama 3: First Truly Usable Open-Source Model; Phi-3; OpenELM
│   ├── 05.md              GPT-4o: When AI Learned to Talk in Real Time; DeepSeek-V2
...
│   ├── 10.md              Nobel Physics Prize (Hopfield & Hinton); Claude 3.5 Sonnet New + Computer Use
│   ├── 11.md              DeepSeek-R1-Lite Preview; Qwen2.5-Coder
│   └── 12.md              DeepSeek-V3; Gemini 2.0; Sora Turbo; Llama 3.3
├── 2025/
│   ├── 01.md              DeepSeek-R1: The "DeepSeek Moment" of Open-Source Reasoning
│   ├── 01_kimi.md          Kimi K1.5: RL's Third Path
...
│   ├── 08.md              GPT-5
│   ├── 09.md              Anthropic Restricts China Access
│   ├── 10.md              Claude Haiku 4.5; Claude Code Web Version
│   ├── 11.md              Grok 4.1 Fast; Claude Code Spy Attack Incident
│   └── 12.md              GPT-5.2: OpenAI's Multi-Mode Defense
└── 2026/
    ├── 01.md              Claude Cowork: From Command Line to Desktop; Anthropic–DoD Dispute
    ├── 02.md              Anthropic Distillation Attack Allegations
    ...
    ├── 04_muse.md         Muse Spark: Llama's End and Meta's New Chapter
    ├── 05.md              Claude Mythos: Vulnerability Weaponization & Export Control Crisis
    └── 06.md              Gemini 3 Pro; Mythos 5/Fable 5; Export Control Revocation
```
...
| Metric | Value |
|--------|-------|
| Annals entries | **66** (2017/06 — 2026/06, all years covered) |
| Biographies | **58** (本纪 ×12 + 世家 ×10 + 列传 ×36) |
| Treatises | **20** |
| Commentary | **18** |
| Tables | **10** |
| **Total** | **172** articles |
