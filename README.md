...
| 指标 | 数值 |
|------|------|
| 编年条目 | **67 篇**（2017/06 — 2026/07，全线覆盖） |
...
| 论 | **18 篇**（Scaling Law 的终结与重生、价格战、开源与闭源、推理模型的分水岭、AI安全与对齐、知识蒸馏与模型压缩、Agent 时代、模型合并与开放权重的未来、数据墙、Test-Time Compute、推理经济学、AI基础设施军备竞赛、数据标注与AI劳动、多语言与文化公平性、后Transformer、OpenAI的分裂与演化、中国AI三条路线、创作者经济与AI生成内容） |
| 表 | **10 篇**（大事年表、模型版本沿革、前沿模型对比、Benchmark速查表、主要融资与估值表、开源模型影响力排行表、训练成本对比表、开源模型许可证对照表、大模型价格沿革表、人物谱系） |
...
这是一个持续编纂的项目。新模型、新事件发生后，按《体例》补入对应月份；重要公司、模型系列和技术另立纪传；跨期主题入志。
